...
const products = [
    ...
    { id: 3, name: "iPhone 16 256Gb (Refurbished) ", price: 399.99, img: "https://m.media-amazon.com/images/I/71QkWOSDkmL.jpg"},
    { id: 4, name: "iPhone 15 256Gb (Refurbished) ", price: 299.99, img: "https://t-mobile.scene7.com/is/image/Tmusprod/Apple-iPhone-15-Pro-Max-Black-Titanium-frontimage"},
...
function renderProducts() {
    ...
    products.forEach(product => {
        ...
        productCard.innerHTML = `
            <h3 style= "font-size: 0.625 em;">${product.name}</h3>
